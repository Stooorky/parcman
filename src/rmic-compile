...
cp parcmanserver/RemoteParcmanServerUser.class ~/public_html/common/parcmanserver/
...
mkdir ~/public_html/common/parcmanagent/exceptions/ 2> /dev/null
cp parcmanagent/exceptions/*.class ~/public_html/common/parcmanagent/exceptions/
mkdir ~/public_html/common/pshell/ 2> /dev/null
cp pshell/*.class ~/public_html/common/pshell/
mkdir ~/public_html/common/indexingserver/ 2> /dev/null
cp indexingserver/RemoteIndexingServer.class ~/public_html/common/indexingserver/
cp indexingserver/RemoteIndexingServerAgent.class ~/public_html/common/indexingserver/
mkdir ~/public_html/common/database/ 2> /dev/null
mkdir ~/public_html/common/database/beans/ 2> /dev/null
cp database/beans/*.class ~/public_html/common/database/beans/
mkdir ~/public_html/common/logserver/ 2> /dev/null
cp logserver/RemoteLogServer.class ~/public_html/common/logserver/
mkdir ~/public_html/common/plog/ 2> /dev/null
cp plog/PLog.class ~/public_html/common/plog/
